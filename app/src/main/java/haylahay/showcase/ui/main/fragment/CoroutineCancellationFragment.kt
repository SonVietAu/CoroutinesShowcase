...
class CoroutineCancellationFragment : CSBaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        refreshAllBtn.setOnClickListener {
            viewModel.refreshAllLottoNumbersButCancellable()
        }

        stopRefreshBtn.text = "Cancel Refreshing"
        stopRefreshBtn.setOnClickListener {
            viewModel.cancelRefreshingCompletely()
        }
    ...
    override fun onResume() {
        super.onResume()
        informationTV.text = activity?.getText(R.string.cancellation_information)
    }
